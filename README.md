...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/green-waterfall-ae36)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/green-waterfall-ae36
```

A live public deployment of this template is available at [https://green-waterfall-ae36.templates.workers.dev](https://green-waterfall-ae36.templates.workers.dev)
